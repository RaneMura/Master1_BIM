...
class Dotplot():
    ...
    def __init__(self):
        ...
        self.check_var = tk.StringVar(value ="on")
    ...
    def recuperer_axes(self,*args):
        ...
        #Vérification des entrées et valeurs
    ...
    def relancer_s_clust_dotplot(self):
        ...
        _,_,self.x,self.y = self.recuperer_axes()
        ...
        self.clust_labels = kmeans.labels_
        self.cluster_nb = k
        ...
        for i in range(len(self.data)):
            self.cluster_points[self.clust_labels[i]].append(self.data_corrected[i])
        ...
        self.scatter_plot = self.ax.scatter(self.x,self.y,s=0.01,c = self.clust_labels)
    ...
    def relancer_snb_dotplot(self):
        ...
        self.scatter_plot = self.ax.scatter(self.x,self.y,s=0.01,c = '#000000')
        self.ax.set_xlabel(self.dp_query)
        self.ax.set_ylabel(self.dp_subject)
    ...
    def relancer_s_dotplot(self):
        ...
        self.scatter_plot = self.ax.scatter(self.x,self.y,s=0.01,c = '#FFFF00')
        self.ax.set_xlabel(self.dp_query)
        self.ax.set_ylabel(self.dp_subject)
    ...
    def relancer_i_ny_dotplot(self):
    ...
    def relancer_i_bw_dotplot(self):
        
        self.ax.clear()
        self.ax.invert_yaxis()
        _,m,_,_ = self.recuperer_axes()
        
        im = self.ax.imshow(m, cmap = "gray")
        self.ax.set_xlabel(self.dp_query)
        self.ax.set_ylabel(self.dp_subject)      
    ...
    def fenetre_dotplot(self):
        ...
        for i in range(7):
            ...
            self.entry_left.grid(row=i,column = 1, sticky = 'ew')
            #self.left_frame.grid_columnconfigure(1,weight=1)

        self.relancer_bouton = ctk.CTkButton(self.left_frame,text = "Relancer Scatter (Bleu/Jaune)", command = self.relancer_s_dotplot)
        self.relancer_bouton.grid(row = 8,column=0,columnspan = 2,padx=10,pady=10,sticky="nsew")
    
        self.relancer_snb_bouton = ctk.CTkButton(self.left_frame,text = "Relancer Scatter (Noir/Blanc)", command = self.relancer_snb_dotplot)
        self.relancer_snb_bouton.grid(row = 9,column=0,columnspan = 2,padx=10,pady=10,sticky="nsew")

        self.relancer_clust_bouton = ctk.CTkButton(self.left_frame,text = "Relancer Scatter avec clusters", command = self.relancer_s_clust_dotplot)
        self.relancer_clust_bouton.grid(row = 10,column=0,columnspan = 2,padx=10,pady=10,sticky="nsew")

        self.relancer_ny_bouton = ctk.CTkButton(self.left_frame,text = "Relancer Imshow (Bleu/Jaune)", command = self.relancer_i_ny_dotplot)
        self.relancer_ny_bouton.grid(row = 11,column=0,columnspan = 2,padx=10,pady=10,sticky="nsew")
        
        self.relancer_wb_bouton = ctk.CTkButton(self.left_frame,text = "Relancer Imshow (Noir/Blanc)", command = self.relancer_i_bw_dotplot)
        self.relancer_wb_bouton.grid(row = 12,column=0,columnspan = 2,padx=10,pady=10,sticky="nsew")
        ...
        self.ax.set_xlabel(self.dp_query,color='white')
        self.ax.set_ylabel(self.dp_subject,color='white')
        ...
        self.toolbar.configure(background='#191919', highlightbackground='#191919', highlightcolor='#191919')
        self.toolbar.update()
